...
#if defined(NDEBUG)
# error "zzboltcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "zzboltcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ZBC additional fees, %d delta bytes\n",
