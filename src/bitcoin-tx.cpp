...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s zzboltcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zzboltcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zzboltcoin transaction") + "\n" +
              "  zzboltcoin-tx [options] -create [commands]   " + _("Create hex-encoded zzboltcoin transaction") + "\n" +
              "\n";
