...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/zzboltcoin-project/zzboltcoin>";
    const std::string URL_WEBSITE = "<https://zzboltcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("zzboltcoin version %s\n", FormatFullVersion());
}
